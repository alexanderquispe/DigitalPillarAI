...
all_regex = {
	'description_':[
		...
		r'\s*(?:roject|project|projection|program|project|strategic|institutional|projects)(?:\s+and)?\s+(?:description|context)',
	...
	'implementation_': [
		r'\s*(?:project|program|institutional)?\s*implementation(\s*\w+){0,3}',
		r'key risks'
	],
	'components_': [
		r'\s*(?:project|program|phase \d+)\s*components$'
	],
	'after_c': [
